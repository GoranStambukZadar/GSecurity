# Firewall.ps1 by Gorstak

function Register-SystemLogonScript {
    param (
        [string]$TaskName = "RunFirewallAtLogon"
    )
...
# Section to paste registry keys to apply and monitor firewall rules
$registryContent = @"
...
"{EC98E237-87E6-4E73-81DA-BCDDBE22D759}"="v2.33|Action=Block|Active=TRUE|Dir=In|Protocol=17|LPort=5353|App=C:\\Program Files (x86)\\Microsoft\\Edge\\Application\\msedge.exe|Name=Microsoft Edge (mDNS-In)|Desc=Inbound rule for Microsoft Edge to allow mDNS traffic.|EmbedCtxt=Microsoft Edge|"
"{CBF258D8-CEB7-4AAF-8B23-B36C94F028E6}"="v2.33|Action=Block|Active=TRUE|Dir=In|Protocol=17|LPort=5353|App=C:\\Program Files (x86)\\Microsoft\\EdgeWebView\\Application\\137.0.3296.93\\msedgewebview2.exe|Name=Microsoft Edge (mDNS-In)|Desc=Inbound rule for Microsoft Edge to allow mDNS traffic.|EmbedCtxt=Microsoft Edge WebView2 Runtime|"
...
"{18D09CCD-6D69-45E5-9169-C787E221C54B}"="v2.33|Action=Block|Active=TRUE|Dir=In|Protocol=17|LPort=5353|App=C:\\Program Files (x86)\\Microsoft\\Edge\\Application\\msedge.exe|Name=Microsoft Edge (mDNS-In)|Desc=Inbound rule for Microsoft Edge to allow mDNS traffic.|EmbedCtxt=Microsoft Edge|"
"{AC8C0C79-4584-4FD8-AFA5-6B1D413CD966}"="v2.33|Action=Block|Active=TRUE|Dir=In|Protocol=17|LPort=5353|App=C:\\Program Files (x86)\\Microsoft\\EdgeWebView\\Application\\137.0.3296.93\\msedgewebview2.exe|Name=Microsoft Edge (mDNS-In)|Desc=Inbound rule for Microsoft Edge to allow mDNS traffic.|EmbedCtxt=Microsoft Edge WebView2 Runtime|"
...
# Execute firewall-related logic
Apply-FirewallRules

# Start firewall monitoring job
Start-Job -Name "GShield-FirewallMonitor" -ScriptBlock {
...
Write-Host "Firewall configuration completed. Monitoring started."